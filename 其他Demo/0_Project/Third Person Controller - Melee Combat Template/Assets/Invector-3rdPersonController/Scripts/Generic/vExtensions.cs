...
namespace Invector
{
    public static class vExtensions
    {
        ...
        public static void Slerp(this v3rdPersonCameraState to, v3rdPersonCameraState from, float time)
        {
            to.Name = from.Name;
        ...
        /// <param name="to"></param>
        /// <param name="from"></param>
        public static void CopyState(this v3rdPersonCameraState to, v3rdPersonCameraState from)
        {
            to.Name = from.Name;
