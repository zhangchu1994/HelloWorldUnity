...
public class vLayerManager : Editor
{
    ...
    {"Player", "Enemy", "CompanionAI", "Triggers", "StopMove", "Action"};

    static List<string> InvectorTags = new List<string>
    {"JumpOver", "ClimbUp", "StepUp", "ExitLadderTop", "ExitLadderBottom", "EnterLadderTop", "ExitLadderBottom", "AutoCrouch", "Ragdoll", "Ignore Ragdoll", "Boss", "Enemy", "CompanionAI", "Weapon", "PlayerUI"};
