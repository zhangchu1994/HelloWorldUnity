...
public class vCreateCharacterEditor : EditorWindow
{
    ...
    void Create()
    {
        ...
        else if (charType == CharacterType.CompanionAI)
        {
            ...
            var s_layer = LayerMask.NameToLayer("StopMove");
            _3rdPerson.GetComponent<v_AICompanion>().stopMoveLayer = LayerMask.GetMask(LayerMask.LayerToName(s_layer));
            var a_layer = LayerMask.NameToLayer("Action");
        ...
        else
        {
            ...
            _3rdPerson.layer = e_layer;
            var s_layer = LayerMask.NameToLayer("StopMove");
            _3rdPerson.GetComponent<v_AIController>().stopMoveLayer = LayerMask.GetMask(LayerMask.LayerToName(s_layer));
            var a_layer = LayerMask.NameToLayer("Action");
