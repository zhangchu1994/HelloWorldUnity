...
namespace Invector
{
    public abstract class vThirdPersonAnimator : vThirdPersonInput
    {
        ...
        /// <summary>
        /// Update animation info on the layers 
        /// </summary>
        void LayerControl()
        {
        ...
        /// <summary>
        /// ATTACK MELEE ANIMATION - trigger the attack animation based on the ID of your weapon, ID will be 0 if you don't have a weapon equipped
        /// </summary>
        void ATK_Animation()
        {
        ...
        /// <summary>
        /// Reset the TriggerAttack to avoid keeping attacking when finish the combat
        /// </summary>
        ...
        /// <summary>
        /// ATTACK MELEE ANIMATION - Trigger a defense animation based on the ID of your weapon, ID will be 0 if you don't have a defense weapon equipped
        /// </summary>
        void DEF_Animation()
        {
            if (meleeManager == null || animator == null) return;
	    ...
	    public void Rolling()
        {
            ...
            bool conditions = (strafing && input != Vector2.zero || speed > 0.25f) && !stopMove && onGround && !landHigh && staminaCondition && !isJumping &&
                (!actions || (actions && (quickTurn || quickStop)));
