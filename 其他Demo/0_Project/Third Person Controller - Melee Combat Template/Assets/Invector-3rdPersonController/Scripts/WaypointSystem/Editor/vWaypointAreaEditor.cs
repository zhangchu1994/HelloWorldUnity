...
namespace Invector
{
    ...
    public class vWaypointAreaEditor : Editor
    {
        ...
        [MenuItem("3rd Person Controller/Component/New Waypoint Area")]
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.BeginVertical("Waypoint Area By Invector", "window", GUILayout.ExpandHeight(false), GUILayout.ExpandWidth(true));
            GUILayout.Space(40);
