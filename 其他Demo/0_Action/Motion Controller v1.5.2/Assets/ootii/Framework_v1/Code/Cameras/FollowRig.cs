...
namespace com.ootii.Cameras
{
    ...
    public class FollowRig : CameraRig
    {
        ...
        /// <summary>
        /// Lerp time to apply to movement
        /// </summary>
        public float _MovementSmooth = 0.8f;
        public float MovementSmooth
        {
            get { return _MovementSmooth; }
            set { _MovementSmooth = value; }
        }

        /// <summary>
        /// Lerp time to apply to rotation
        /// </summary>
        public float _RotationSmooth = 0.95f;
        public float RotationSmooth
        {
            get { return _RotationSmooth; }
            set { _RotationSmooth = value; }
        }
        ...
        public void ApplyMovement()
        {
            ...
            {
                lNewRigPosition = Vector3.Lerp(transform.position, lNewRigPosition, _MovementSmooth);
            }
        ...
        private void ApplyRotation()
        {
            ...
            {
                lViewRotation = Quaternion.Slerp(transform.rotation, lViewRotation, _RotationSmooth);
            }
