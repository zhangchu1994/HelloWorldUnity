...
namespace com.ootii.AI.Controllers
{
    ...
    public class Controller : BaseMonoObject
    {
        ...
        /// <summary>
        /// Radius of the actor for distance and collision checking
        /// </summary>
        public virtual float ActorRadius
        {
            get { return 0f; }
        }
        ...
        /// <returns></returns>
        public virtual bool SafeRaycast(Vector3 rRayStart, Vector3 rRayDirection, float rDistance)
        {
            return RaycastExt.SafeRaycast(rRayStart, rRayDirection, ref mRaycastHitInfo, rDistance, null);
        }
        ...
        /// <returns></returns>
        public virtual bool SafeRaycast(Vector3 rRayStart, Vector3 rRayDirection, float rDistance, int rMask)
        {
            return RaycastExt.SafeRaycast(rRayStart, rRayDirection, ref mRaycastHitInfo, rDistance, rMask, null);
        }
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public virtual bool SafeRaycast(Vector3 rRayStart, Vector3 rRayDirection, ref RaycastHit rHitInfo, float rDistance)
        {
            return RaycastExt.SafeRaycast(rRayStart, rRayDirection, ref rHitInfo, rDistance, null);
        }
        ...
        /// <param name="rMask"></param>
        /// <returns></returns>
        public virtual bool SafeRaycast(Vector3 rRayStart, Vector3 rRayDirection, ref RaycastHit rHitInfo, float rDistance, int rMask)
        {
            return RaycastExt.SafeRaycast(rRayStart, rRayDirection, ref rHitInfo, rDistance, rMask, null);
        }
        ...
        /// <param name="rDistance"></param>
        /// <returns></returns>
        public virtual bool SafeRaycastAll(Vector3 rRayStart, Vector3 rRayDirection, ref RaycastHit rHitInfo, float rDistance)
        {
            RaycastHit[] lHitInfo = RaycastExt.SafeRaycastAll(rRayStart, rRayDirection, rDistance, null);
