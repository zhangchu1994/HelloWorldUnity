...
namespace com.ootii.AI.Controllers
{
    ...
    public class Slide : MotionControllerMotion
    {
        ...
        public override void LoadAnimatorData()
        {
            ...
            mController.AddAnimatorName("Entry -> " + lBaseLayer + "Slide-SM.Slide");
            mController.AddAnimatorName("AnyState -> " + lBaseLayer + "Slide-SM.Slide");

            mController.AddAnimatorName(lBaseLayer + "Slide-SM.Slide");
        }
