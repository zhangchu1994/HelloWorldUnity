...
namespace com.ootii.AI.Controllers
{
    ...
    public class ClimbCrouch : MotionControllerMotion
    {
        ...
        public override void LoadAnimatorData()
        {
            ...
            mController.AddAnimatorName("Entry -> " + lBaseLayer + "ClimbCrouch-SM.IdleToClimbCrouch");
            mController.AddAnimatorName("Entry -> " + lBaseLayer + "ClimbCrouch-SM.JumpRiseToClimbCrouch");
            mController.AddAnimatorName("Entry -> " + lBaseLayer + "ClimbCrouch-SM.JumpTopToClimbCrouch");
            mController.AddAnimatorName("Entry -> " + lBaseLayer + "ClimbCrouch-SM.JumpFallToClimbCrouch");
            mController.AddAnimatorName("Entry -> " + lBaseLayer + "ClimbCrouch-SM.JumpImpactToClimbCrouch");

            mController.AddAnimatorName("AnyState -> " + lBaseLayer + "ClimbCrouch-SM.IdleToClimbCrouch");
            mController.AddAnimatorName("AnyState -> " + lBaseLayer + "ClimbCrouch-SM.JumpRiseToClimbCrouch");
            mController.AddAnimatorName("AnyState -> " + lBaseLayer + "ClimbCrouch-SM.JumpTopToClimbCrouch");
            mController.AddAnimatorName("AnyState -> " + lBaseLayer + "ClimbCrouch-SM.JumpFallToClimbCrouch");
            mController.AddAnimatorName("AnyState -> " + lBaseLayer + "ClimbCrouch-SM.JumpImpactToClimbCrouch");
            ...
            mController.AddAnimatorName(lBaseLayer + "Jump-SM.JumpRise -> " + lBaseLayer + "ClimbCrouch-SM.JumpRiseToClimbCrouch");

            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.IdleToClimbCrouch");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.JumpRiseToClimbCrouch");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.JumpFallToClimbCrouch");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.JumpTopToClimbCrouch");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.JumpImpactToClimbCrouch");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchToTop");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchToJumpFall");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchToJumpFall");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchToTop");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchToTop -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchRecoverIdle");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchRecoverIdle");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchRecoverIdle -> " + lBaseLayer + "Idle-SM.Idle_Casual");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchRecoverIdle -> " + lBaseLayer + "Idle-SM.Idle_Alert");

            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyLeft");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyRight");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyLeft");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyRight");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyLeft -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose");
            mController.AddAnimatorName(lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyRight -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose");
        }
        ...
        public override bool TestActivate()
        {
            ...
            else
            {
                ...
                {
                    mGrabMotion = 1;
                    lEdgeGrabbed = TestGrab(mController.transform.position, mController.transform.rotation, mController.transform.forward, mController.ActorRadius, 1.20f * mController.ActorScale, 1.35f * mController.ActorScale);
                }
                // If we're at the peak
                else if (mController.State.Velocity.y > -2f)
                {
                    mGrabMotion = 2;
                    lEdgeGrabbed = TestGrab(mController.transform.position, mController.transform.rotation, mController.transform.forward, mController.ActorRadius, 1.00f * mController.ActorScale, 1.20f * mController.ActorScale);
                }
                // When falling, we just test for a grab
                else
                {
                    mGrabMotion = 3;
                    lEdgeGrabbed = TestGrab(mController.transform.position, mController.transform.rotation, mController.transform.forward, mController.ActorRadius, 1.00f * mController.ActorScale, 1.42f * mController.ActorScale);
                }
        ...
        public override void Deactivate()
        {
            ...
            // Reenable collisions
            Collider lCharCollider = mController.CharController.GetComponent<Collider>();
            Collider lObstacleCollider = mClimbable.GetComponent<Collider>();

            UnityEngine.Physics.IgnoreCollision(lCharCollider, lObstacleCollider, false);
            mClimbable = null;
        ...
        public override void CleanRootMotion(ref Vector3 rVelocityDelta, ref Quaternion rRotationDelta)
        {
            ...
            if (lStateName == lBaseLayer + "ClimbCrouch-SM.ClimbCrouchRecoverIdle")
            {
                //rVelocityDelta.y = 0f;
            }

            // Some checks not needed since we baked the root motion
            if (lStateName == "Entry -> ClimbCrouch-SM.JumpRiseToClimbCrouch" ||
                lStateName == "AnyState -> ClimbCrouch-SM.JumpRiseToClimbCrouch" ||
                lStateName == lBaseLayer + "ClimbCrouch-SM.JumpFallToClimbCrouch" ||
                lStateName == lBaseLayer + "ClimbCrouch-SM.JumpImpactToClimbCrouch" ||
                lStateName == lBaseLayer + "ClimbCrouch-SM.JumpTopToClimbCrouch" ||
                lStateName == lBaseLayer + "ClimbCrouch-SM.ClimbCrouchRecoverIdle"
                )
            {
                rVelocityDelta.x = 0f;
                rVelocityDelta.z = 0f;
        ...
        public override void UpdateMotion()
        {
            ...
            else if (lStateName == lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose")
            {
                // Test if we should shimmy left
                if (mController.UseInput && ootiiInputStub.IsPressed("MoveLeft"))
                {
                ...
                else if (mController.UseInput && ootiiInputStub.IsPressed("MoveRight"))
                {
                    if (TestShimmy(mMinSideSpaceForMove))
                    {
                ...
                else if (mController.UseInput && (ootiiInputStub.IsJustPressed("Jump") || ootiiInputStub.IsPressed("MoveUp")))
                {
                    Collider lCharCollider = mController.CharController.GetComponent<Collider>();
                    Collider lObstacleCollider = mClimbable.GetComponent<Collider>();

                    // As we start the climb to the top, disable the collision
                    UnityEngine.Physics.IgnoreCollision(lCharCollider, lObstacleCollider, true);
                ...
                else if (mController.State.GroundDistance < mMinGroundDistance || (mController.UseInput && ootiiInputStub.IsJustPressed("Release")))
                {
                    // Start the drop
                    mPhase = ClimbCrouch.PHASE_TO_FALL;
                    mController.SetAnimatorMotionPhase(mAnimatorLayerIndex, ClimbCrouch.PHASE_TO_FALL);
            ...
            else if (IsInClimbShimmy)
            {
                ...
                if (mController.SafeRaycast(mController.transform.position, mController.transform.forward, ref sCollisionUpdateInfo, lDistance * mController.ActorScale * 1.5f, lIsClimbableMask))
                {
            ...
            else if (lStateName == lBaseLayer + "ClimbCrouch-SM.ClimbCrouchToTop")
            {
            ...
            else if (lStateName == lBaseLayer + "ClimbCrouch-SM.ClimbCrouchRecoverIdle")
            {
            ...
            else if (lStateName == lBaseLayer + "ClimbCrouch-SM.ClimbCrouchToJumpFall")
            {
        ...
        public virtual bool TestGrab(Vector3 rPosition, Quaternion rRotation, Vector3 rForward, float rRadius, float rBottom, float rTop)
        {
            ...
            if (!mController.SafeRaycast(lRayStart, rForward, ref sCollisionInfo, lTargetDistance * mController.ActorScale, lIsClimbableMask))
            {
                return false;
            }
        ...
        private bool TestShimmy(float rOffset)
        {
            ...
            if (!TestGrab(lFuturePosition, mController.transform.rotation, mController.transform.forward, mController.ActorRadius, 1.0f * mController.ActorScale, 1.5f * mController.ActorScale))
            {
                return false;
            }
        ...
        public override void OnAnimatorStateChange(int rLastStateID, int rNewStateID)
        {
            ...
            if (rNewStateID == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpRiseToClimbCrouch"] ||
                rNewStateID == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpFallToClimbCrouch"] ||
                rNewStateID == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpImpactToClimbCrouch"] ||
                rNewStateID == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpTopToClimbCrouch"])
            {
            ...
            if (rLastStateID == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchRecoverIdle"])
            {
        ...
        protected bool IsInClimbUpState
        {
            get
            {
                ...
                if (lTransitionHash == mController.AnimatorStateIDs["Entry -> " + lBaseLayer + "ClimbCrouch-SM.JumpRiseToClimbCrouch"] ||
                    lTransitionHash == mController.AnimatorStateIDs["AnyState -> " + lBaseLayer + "ClimbCrouch-SM.JumpRiseToClimbCrouch"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.IdleToClimbCrouch"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpRiseToClimbCrouch"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpTopToClimbCrouch"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpFallToClimbCrouch"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpImpactToClimbCrouch"]
                    )
                {
                    return true;
                }
        ...
        protected bool IsInClimbIdleState
        {
            get
            {
                ...
                if (mController.CompareAnimatorStateName(mAnimatorLayerIndex, lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose"))
                {
                    return true;
                }
        ...
        protected bool IsInClimbState
        {
            get
            {
                ...
                if (lTransitionHash == mController.AnimatorStateIDs["Entry -> " + lBaseLayer + "ClimbCrouch-SM.JumpRiseToClimbCrouch"] ||
                    lTransitionHash == mController.AnimatorStateIDs["Entry -> " + lBaseLayer + "ClimbCrouch-SM.IdleToClimbCrouch"] ||
                    lTransitionHash == mController.AnimatorStateIDs["Entry -> " + lBaseLayer + "ClimbCrouch-SM.JumpTopToClimbCrouch"] ||
                    lTransitionHash == mController.AnimatorStateIDs["Entry -> " + lBaseLayer + "ClimbCrouch-SM.JumpFallToClimbCrouch"] ||
                    lTransitionHash == mController.AnimatorStateIDs["Entry -> " + lBaseLayer + "ClimbCrouch-SM.JumpImpactToClimbCrouch"] ||
                    lTransitionHash == mController.AnimatorStateIDs["AnyState -> " + lBaseLayer + "ClimbCrouch-SM.JumpRiseToClimbCrouch"] ||
                    lTransitionHash == mController.AnimatorStateIDs["AnyState -> " + lBaseLayer + "ClimbCrouch-SM.IdleToClimbCrouch"] ||
                    lTransitionHash == mController.AnimatorStateIDs["AnyState -> " + lBaseLayer + "ClimbCrouch-SM.JumpTopToClimbCrouch"] ||
                    lTransitionHash == mController.AnimatorStateIDs["AnyState -> " + lBaseLayer + "ClimbCrouch-SM.JumpFallToClimbCrouch"] ||
                    lTransitionHash == mController.AnimatorStateIDs["AnyState -> " + lBaseLayer + "ClimbCrouch-SM.JumpImpactToClimbCrouch"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.IdleToClimbCrouch"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpRiseToClimbCrouch"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpTopToClimbCrouch"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpFallToClimbCrouch"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.JumpImpactToClimbCrouch"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchToTop"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchRecoverIdle"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchToJumpFall"] ||

                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyLeft"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyRight"] ||
                    lTransitionHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyLeft"] ||
                    lTransitionHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyRight"] ||
                    lTransitionHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyLeft -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose"] ||
                    lTransitionHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyRight -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose"]
                    )
                {
                    return true;
                }
        ...
        protected bool IsInClimbShimmy
        {
            get
            {
                ...
                if (lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyLeft"] ||
                    lStateHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyRight"] ||
                    lTransitionHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyLeft"] ||
                    lTransitionHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyRight"] ||
                    lTransitionHash == mController.AnimatorStateIDs[lBaseLayer + "ClimbCrouch-SM.ClimbCrouchShimmyLeft -> " + lBaseLayer + "ClimbCrouch-SM.ClimbCrouchPose"] ||
