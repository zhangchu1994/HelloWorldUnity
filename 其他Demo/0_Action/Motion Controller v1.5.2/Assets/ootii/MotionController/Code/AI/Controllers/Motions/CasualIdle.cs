...
namespace com.ootii.AI.Controllers
{
    ...
    public class CasualIdle : MotionControllerMotion
    {
        ...
        public override void LoadAnimatorData()
        {
            ...
            mController.AddAnimatorName("Entry -> " + lBaseLayer + "Idle-SM.Idle_Casual");
            mController.AddAnimatorName("AnyState -> " + lBaseLayer + "Idle-SM.Idle_Casual");

            mController.AddAnimatorName(lBaseLayer + "Idle-SM.Idle_Casual");
            mController.AddAnimatorName(lBaseLayer + "Idle-SM.IdleRotateLeft90");
            mController.AddAnimatorName(lBaseLayer + "Idle-SM.IdleRotateRight90");
            mController.AddAnimatorName(lBaseLayer + "Idle-SM.IdleRotateLeft135");
            mController.AddAnimatorName(lBaseLayer + "Idle-SM.IdleRotateRight135");
            mController.AddAnimatorName(lBaseLayer + "Idle-SM.IdleRotate180");
        }
        ...
        public bool IsInPivotState
        {
            get
            {
                ...
                if (lState == lBaseLayer + "Idle-SM.IdleRotateLeft90" ||
                    lState == lBaseLayer + "Idle-SM.IdleRotateRight90" ||
                    lState == lBaseLayer + "Idle-SM.IdleRotateLeft135" ||
                    lState == lBaseLayer + "Idle-SM.IdleRotateRight135" ||
                    lState == lBaseLayer + "Idle-SM.IdleRotate180")
                {
                    return true;
                }
