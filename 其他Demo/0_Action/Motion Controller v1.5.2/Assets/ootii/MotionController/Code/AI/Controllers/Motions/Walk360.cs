...
{
    /// <summary>
    /// The Walk360 motion was built specifically for the Adventure Camera for use when 
    /// the character is aiming (zoomed in). It's what allows the character to always face forward while aiming.
    /// </summary>
    [MotionTooltip("Built specifically for the Adventure Camera for use when " +
                   " the character is aiming (zoomed in). It's what allows the character to always face forward while aiming.")]
    public class Walk360 : MotionControllerMotion
    {
        ...
        public override void LoadAnimatorData()
        {
            ...
            mController.AddAnimatorName("Entry -> " + lBaseLayer + "Walk360-SM.WalkBlend");
            mController.AddAnimatorName("AnyState -> " + lBaseLayer + "Walk360-SM.WalkBlend");

            mController.AddAnimatorName(lBaseLayer + "Walk360-SM.WalkBlend");
        }
        ...
        public override bool TestActivate()
        {
            ...
            if (ootiiInputStub.IsPressed("Aiming")) { return true; }
        ...
        public override bool TestUpdate()
        {
            ...
            if (!ootiiInputStub.IsPressed("Aiming")) { return false; }
        ...
        public bool IsInWalkState
        {
            get
            {
                ...
                if (lTransition == "Entry -> " + lBaseLayer + "Walk360-SM.WalkBlend" ||
                    lTransition == "AnyState -> " + lBaseLayer + "Walk360-SM.WalkBlend" ||
                    lState == lBaseLayer + "Walk360-SM.WalkBlend")
                {
                    return true;
                }
