...
namespace com.ootii.AI.Controllers
{
    ...
    public class SimpleForward : MotionControllerMotion
    {
        ...
        public override void LoadAnimatorData()
        {
            ...
            mController.AddAnimatorName("Entry -> " + lBaseLayer + "SimpleForward-SM.Forward");
            mController.AddAnimatorName("AnyState -> " + lBaseLayer + "SimpleForward-SM.Forward");

            mController.AddAnimatorName(lBaseLayer + "SimpleForward-SM.Forward");
        }
        ...
        public bool IsInRunState
        {
            get
            {
                ...
                if (lTransition == "Entry -> " + lBaseLayer + "SimpleForward-SM.Forward" ||
                    lTransition == "AnyState -> " + lBaseLayer + "SimpleForward-SM.Forward" ||
                    lState == lBaseLayer + "SimpleForward-SM.Forward")
                {
                    return true;
                }
