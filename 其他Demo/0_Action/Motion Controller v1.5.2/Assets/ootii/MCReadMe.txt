...
3. Extract 'InputManager.asset' from 'ootii/MotionController/Extras/InputManager.zip' to your 'ProjectSettings' folder

4. Open 'Demo' scene from 'ootii/MotionController/Demos/Scenes' folder
